package requimrar.Minecraft.RChem.Client.Renderer;
...
public class ItemCompoundRenderer implements IItemRenderer
{
	...
	private void RenderItemInInventory(ItemStack itemstack)
	{
		...
		if(ItemCompound.GetCompoundFromIS(itemstack).IsElement())
			RenderElementName(RChemMod.GetCompoundList()[itemstack.getItemDamage()].GetChemName(), ItemCompound.GetCompoundFromIS(itemstack));
