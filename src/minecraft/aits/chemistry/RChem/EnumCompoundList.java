...
import static requimrar.Minecraft.RChem.EnumCompoundList.Al;
import static requimrar.Minecraft.RChem.EnumCompoundList.Ba;
import static requimrar.Minecraft.RChem.EnumCompoundList.Ca;
import static requimrar.Minecraft.RChem.EnumCompoundList.Cd;
import static requimrar.Minecraft.RChem.EnumCompoundList.Co2;
import static requimrar.Minecraft.RChem.EnumCompoundList.Cr2;
import static requimrar.Minecraft.RChem.EnumCompoundList.Fe2;
import static requimrar.Minecraft.RChem.EnumCompoundList.H2;
import static requimrar.Minecraft.RChem.EnumCompoundList.HCl;
import static requimrar.Minecraft.RChem.EnumCompoundList.Mg;
import static requimrar.Minecraft.RChem.EnumCompoundList.Mn2;
import static requimrar.Minecraft.RChem.EnumCompoundList.Ni;
import static requimrar.Minecraft.RChem.EnumCompoundList.Pb;
import static requimrar.Minecraft.RChem.EnumCompoundList.Sn2;
import static requimrar.Minecraft.RChem.EnumCompoundList.Sr;
import static requimrar.Minecraft.RChem.EnumCompoundList.Zn;
...
public enum EnumCompoundList
{
	...
	BaƒClO4π2		("Barium Perchlorate", 0, Ionic, new Compound[]{ new Compound(Ba, Cation), new Compound(iClO4, 2, Anion) }, -300, -300, "", -1, Stable),
	SrƒClO4π2		("Strontium Perchlorate", 0, Ionic, new Compound[]{ new Compound(Sr, Cation), new Compound(iClO4, 2, Anion) }, -300, -300, "", -1, Stable),
	CaƒClO4π2		("Calcium Perchlorate", 0, Ionic, new Compound[]{ new Compound(Ca, Cation), new Compound(iClO4, 2, Anion) }, -300, -300, "", -1, Stable),
	MgƒClO4π2		("Magnesium Perchlorate", 0, Ionic, new Compound[]{ new Compound(Mg, Cation), new Compound(iClO4, 2, Anion) }, -300, -300, "", -1, Stable),
	ZnƒClO4π2		("Zinc Perchlorate", 0, Ionic, new Compound[]{ new Compound(Zn, Cation), new Compound(iClO4, 2, Anion) }, -300, -300, "", -1, Stable),
	Cr$2ƒClO4π2		("Chromium(II) Perchlorate", 0, Ionic, new Compound[]{ new Compound(Cr2, Cation), new Compound(iClO4, 2, Anion) }, -300, -300, "", -1, Stable),
	Fe$2ƒClO4π2		("Iron(II) Perchlorate", 0, Ionic, new Compound[]{ new Compound(Fe2, Cation), new Compound(iClO4, 2, Anion) }, -300, -300, "", -1, Stable),
	Mn$2ƒClO4π2		("Manganese(II) Perchlorate", 0, Ionic, new Compound[]{ new Compound(Mn2, Cation), new Compound(iClO4, 2, Anion) }, -300, -300, "", -1, Stable),
	Co$2ƒClO4π2		("Cobalt(II) Perchlorate", 0, Ionic, new Compound[]{ new Compound(Co2, Cation), new Compound(iClO4, 2, Anion) }, -300, -300, "", -1, Stable),
	Sn$2ƒClO4π2		("Tin(II) Perchlorate", 0, Ionic, new Compound[]{ new Compound(Sn2, Cation), new Compound(iClO4, 2, Anion) }, -300, -300, "", -1, Stable),
	CdƒClO4π2		("Cadmium Perchlorate", 0, Ionic, new Compound[]{ new Compound(Cd, Cation), new Compound(iClO4, 2, Anion) }, -300, -300, "", -1, Stable),
	NiƒClO4π2		("Nickel Perchlorate", 0, Ionic, new Compound[]{ new Compound(Ni, Cation), new Compound(iClO4, 2, Anion) }, -300, -300, "", -1, Stable),
	PbƒClO4π2		("Lead Perchlorate", 0, Ionic, new Compound[]{ new Compound(Pb, Cation), new Compound(iClO4, 2, Anion) }, -300, -300, "", -1, Stable),

	AlƒClO4π3		("Aluminium Perchlorate", 0, Ionic, new Compound[]{ new Compound(Al, Cation), new Compound(iClO4, 3, Anion) }, -300, -300, "", -1, Stable),
	Fe$3ƒClO4π3		("Iron(III) Perchlorate", 0, Ionic, new Compound[]{ new Compound(Fe3, Cation), new Compound(iClO4, 3, Anion) }, -300, -300, "", -1, Stable),
	...
	// ƒ denotes an opening bracket.
	// π denotes a closing bracket.
	...
	BaƒNO3π2		("Barium Nitrate", 0, Ionic, new Compound[]{ new Compound(Ba, Cation), new Compound(iNO3, 2, Anion) }, -300, -300, "", -1, Stable),
	SrƒNO3π2		("Strontium Nitrate", 0, Ionic, new Compound[]{ new Compound(Sr, Cation), new Compound(iNO3, 2, Anion) }, -300, -300, "", -1, Stable),
	CaƒNO3π2		("Calcium Nitrate", 0, Ionic, new Compound[]{ new Compound(Ca, Cation), new Compound(iNO3, 2, Anion) }, -300, -300, "", -1, Stable),
	MgƒNO3π2		("Magnesium Nitrate", 0, Ionic, new Compound[]{ new Compound(Mg, Cation), new Compound(iNO3, 2, Anion) }, -300, -300, "", -1, Stable),
	Mn$2ƒNO3π2		("Manganese(II) Nitrate", 0, Ionic, new Compound[]{ new Compound(Mn2, Cation), new Compound(iNO3, 2, Anion) }, -300, -300, "", -1, Stable),
	Fe$2ƒNO3π2		("Iron(II) Nitrate", 0, Ionic, new Compound[]{ new Compound(Fe2, Cation), new Compound(iNO3, 2, Anion) }, -300, -300, "", -1, Stable),
	Co$2ƒNO3π2		("Cobalt(II) Nitrate", 0, Ionic, new Compound[]{ new Compound(Co2, Cation), new Compound(iNO3, 2, Anion) }, -300, -300, "", -1, Stable),
	Sn$2ƒNO3π2		("Tin(II) Nitrate", 0, Ionic, new Compound[]{ new Compound(Sn2, Cation), new Compound(iNO3, 2, Anion) }, -300, -300, "", -1, Stable),
	ZnƒNO3π2		("Zinc Nitrate", 0, Ionic, new Compound[]{ new Compound(Zn, Cation), new Compound(iNO3, 2, Anion) }, -300, -300, "", -1, Stable),
	Cr$2ƒNO3π2		("Chromium(II) Nitrate", 0, Ionic, new Compound[]{ new Compound(Cr2, Cation), new Compound(iNO3, 2, Anion) }, -300, -300, "", -1, Stable),
	CdƒNO3π2		("Cadmium Nitrate", 0, Ionic, new Compound[]{ new Compound(Cd, Cation), new Compound(iNO3, 2, Anion) }, -300, -300, "", -1, Stable),
	NiƒNO3π2		("Nickel Nitrate", 0, Ionic, new Compound[]{ new Compound(Ni, Cation), new Compound(iNO3, 2, Anion) }, -300, -300, "", -1, Stable),
	PbƒNO3π2		("Lead Nitrate", 0, Ionic, new Compound[]{ new Compound(Pb, Cation), new Compound(iNO3, 2, Anion) }, -300, -300, "", -1, Stable),

	AlƒNO3π3		("Aluminium Nitrate", 0, Ionic, new Compound[]{ new Compound(Al, Cation), new Compound(iNO3, 3, Anion) }, -300, -300, "", -1, Stable),
	Fe$3ƒNO3π3		("Iron(III) Nitrate", 0, Ionic, new Compound[]{ new Compound(Fe3, Cation), new Compound(iNO3, 3, Anion) }, -300, -300, "", -1, Stable),


	// Sulphate Salts
	ƒNH4π2SO4		("Ammonium Sulphate", 0, Ionic, new Compound[]{ new Compound(iNH4, 2, Cation), new Compound(iSO4, Anion) }, -300, -300, "", -1, Stable),
	...
	Al2ƒSO4π3		("Aluminium Sulphate", 0, Ionic, new Compound[]{ new Compound(Al, 2, Cation), new Compound(iSO4, 3, Anion) }, -300, -300, "", -1, Stable),
	Fe$32ƒSO4π3		("Iron(III) Sulphate", 0, Ionic, new Compound[]{ new Compound(Fe3, 2, Cation), new Compound(iSO4, 3, Anion) }, -300, -300, "", -1, Stable),
	...
	public String GetChemName()
	{
		...
		else if(this.name().contains("π") || this.name().contains("ƒ"))
		{
