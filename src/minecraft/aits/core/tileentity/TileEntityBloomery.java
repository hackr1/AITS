...
public class TileEntityBloomery extends TileEntity implements IInventory, ISidedInventory{
	 ...
	 * *no because this class provides the method and other classes GET the value! *
	 */
	@Override
	...
	public void smeltItem()
	{
		if (this.canSmelt())
		{
			ItemStack var1 = BloomeryRecipes.getProduct(this.furnaceItemStacks[0].getItem().getClass());
