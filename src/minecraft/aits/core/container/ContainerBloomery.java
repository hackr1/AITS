...
{
    private TileEntityBloomery furnace;
    private int lastCookTime = 0;
    private int lastBurnTime = 0;
    private int lastItemBurnTime = 0;

    public ContainerBloomery(InventoryPlayer par1InventoryPlayer, TileEntityBloomery par2TileEntityFurnace)
    {
        ...
        this.addSlotToContainer(new SlotBloomery(par1InventoryPlayer.player, par2TileEntityFurnace, 2, 116, 35));
        int var3;
