...
{
    private TileEntityBloomery furnaceInventory;

    public GuiBloomery(InventoryPlayer par1InventoryPlayer, TileEntityBloomery par2TileEntityFurnace)
    {
    ...
    {
        this.fontRenderer.drawString("Bloomery", 60, 6, 4210752);
